...
EXTAPI_DLLEXPORT simxInt simxCustomSetJointsTargetPositions(simxInt clientId, simxInt handleCount, simxInt* handles, simxFloat* positions, simxInt operationMode);/* related to command ID simx_customcmd_set_joints_target_positions */
